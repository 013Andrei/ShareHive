...
const Homepage = () => {
  return (
    <div className=''>
      <div className="pt-4 flex justify-between text-textGray font-bold border-b-[1px] border-yellow-500">
        <Link className="pb-3 flex items-center border-b-4 border-yellow-400" href="/">For you</Link>
